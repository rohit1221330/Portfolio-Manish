...
const steps = [
  {
    ...
    description: (
      <span className="leading-loose">
        I edit from
        <span className="px-2 py-0.5 mx-1 font-bold text-orange-200 bg-orange-500/20 border border-orange-500/30 rounded shadow-[0_0_10px_rgba(249,115,22,0.2)]">
          audience psychology
        </span>
        — not random cuts. Understanding the "Why" before the "How".
      </span>
    ),
  },
  {
    ...
    description: (
      <span className="leading-loose">
        Every second crafted to keep  viewers watching.
  ...
  },
  {
    ...
    description: (
      <span className="leading-loose">
        Clean pacing, crisp audio, modern storytelling. Turning chaos into
        <span className="px-2 py-0.5 mx-1 font-bold text-orange-200 bg-orange-500/20 border border-orange-500/30 rounded shadow-[0_0_10px_rgba(249,115,22,0.2)]">
          coherence.
        </span>
            ...
            {steps.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute z-20 left-3 top-8 lg:hidden">
                    <div className={`
                      ...
                      <div className={`relative z-10 flex flex-col gap-3 md:gap-6 items-start ${isLeft ? 'lg:items-end' : 'lg:items-start'}`}>
                        ...
                        `}>
                          ...
                          <div className="flex-1">
                            ...
                            <h3 className="text-lg font-bold leading-none text-white md:text-3xl font-cinematic">
                              {step.title}
                            </h3>
                          </div>
                        </div>
                        ...
                        {/* Description */}
                        <p className="font-sans text-xs leading-relaxed text-gray-400 md:text-lg group-hover:text-gray-300">
                          {step.description}
                        </p>
